        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseInputs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ExpenseInputId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_ExpenseGroupId",
                table: "Accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseInputs_CreatedAt",
                table: "ExpenseInputs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseInputs_UserId",
                table: "ExpenseInputs",
                column: "UserId");
